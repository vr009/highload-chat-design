...
и сохранить в персистентную базу. Реализуе репликацию между датацентрами для ускорения работы переписок между географически
распределенными пользователями.
