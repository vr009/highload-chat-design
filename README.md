...
максимальное возможное количество коннектов на один сервер. При должном тюнинге Linux машины
можно настроить так, чтобы макс количество коннектов к серверу было около 65тыс. Тогда рассчитаем кол-во серверов на регион
...
Для хранения 114 ТБ берем сервер с RAID 10 по 4ТБ NVMe 16шт
